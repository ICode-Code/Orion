...
namespace OE1Core
{
	namespace Renderer
	{
		...
		void IVFlatMaterialMeshRenderer::Render(Core::IVCoreDrawStaticMeshDataBuffer& _data, int _camera_idx)
		{
		...
		void IVFlatMaterialMeshRenderer::Render(Core::IVCoreDrawDynamicMeshDataBuffer& _data, int _camera_idx)
		{
			for (auto iter = _data.begin(); iter != _data.end(); iter++)
			{
