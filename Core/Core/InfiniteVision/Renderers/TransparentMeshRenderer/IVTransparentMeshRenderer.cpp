...
namespace OE1Core
{
	namespace Renderer
	{
		...
		void IVTransparentMeshRenderer::Render(Core::IVCoreDrawStaticMeshDataBuffer& _data, int _camera_idx)
		{
		...
		void IVTransparentMeshRenderer::Render(Core::IVCoreDrawDynamicMeshDataBuffer& _data, int _camera_idx)
		{
			for (auto iter = _data.begin(); iter != _data.end(); iter++)
			{
